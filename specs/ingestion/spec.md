...
- [ ] D1 stores encrypted per-connector credential payloads, backed by a Wrangler-managed root encryption key, with authenticated owner-scoped create/update/delete/status routes that never return plaintext secrets.
