/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f3b6dbe0d209c3daae73745bedd6ab6)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<Pick<Cloudflare.Env, "BRAINFOG_TOKEN_HASH_SECRET">> {}
}
