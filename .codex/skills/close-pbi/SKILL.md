---
name: close-pbi
description: Use when finishing a PBI: verify implementation against the task and spec, update completion evidence, and prepare closeout without pushing unless asked. Works for Codex and OpenCode.
---
...
5. Completion evidence must cover project invariants defined in `ARCHITECTURE.md` and accepted ADRs.
