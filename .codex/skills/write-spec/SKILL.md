---
name: write-spec
description: Use when starting a new feature spec under specs/ or adding a major capability to an existing spec.
---

# Skill: Write A Spec

Use this when starting a new feature area under `specs/`, or adding a major capability to an existing one. Delegate spec writing to `@architect`.
