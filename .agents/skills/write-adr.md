...
Use this when a decision needs to be recorded as an Architecture Decision Record under `docs/adrs/`.
...
- Every alternative in "Alternatives Considered" needs a *specific* reason, not "didn't fit" — specific enough that someone re-litigating the decision later can see what would have to change for the alternative to become the right choice.
